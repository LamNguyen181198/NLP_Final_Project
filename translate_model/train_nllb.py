...
from translate_model.nllb import DEFAULT_MODEL_ID, normalize_language_code
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune an NLLB translation model.")
    ...
    parser.add_argument("--base_model", default=DEFAULT_MODEL_ID, help=f"Base translation model (default: {DEFAULT_MODEL_ID})")
    parser.add_argument("--source_lang", default="eng_Latn", help="NLLB source language code")
    parser.add_argument("--target_lang", default="eng_Latn", help="NLLB target language code")
...
def main() -> None:
    ...
    source_lang = normalize_language_code(args.source_lang)
    target_lang = normalize_language_code(args.target_lang)
    if not source_lang:
